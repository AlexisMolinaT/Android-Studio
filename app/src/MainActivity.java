...
public class MainActivity extends AppCompatActivity {
    ...
    public void mostrarEstadisticas(){
        ...
        String str_lado2_porcentaje;
        str_lado2_porcentaje = "%";
        int lado2_porcentaje = (lado2*100)/totales;
        textView_lado2_porcentaje.setText(lado2_porcentaje + str_lado2_porcentaje);
        progressBar_lado2.setProgress(lado2_porcentaje);
        String str_lado3_porcentaje;
        str_lado3_porcentaje = "%";
        int lado3_porcentaje = (lado3*100)/totales;
        textView_lado3_porcentaje.setText(lado3_porcentaje + str_lado3_porcentaje);
        progressBar_lado3.setProgress(lado3_porcentaje);
        String str_lado4_porcentaje;
        str_lado4_porcentaje = "%";
        int lado4_porcentaje = (lado4*100)/totales;
        textView_lado4_porcentaje.setText(lado4_porcentaje + str_lado4_porcentaje);
        progressBar_lado4.setProgress(lado4_porcentaje);
        String str_lado5_porcentaje;
        str_lado5_porcentaje = "%";
        int lado5_porcentaje = (lado5*100)/totales;
        textView_lado5_porcentaje.setText(lado5_porcentaje + str_lado5_porcentaje);
        progressBar_lado5.setProgress(lado5_porcentaje);
        String str_lado6_porcentaje;
        str_lado6_porcentaje = "%";
        int lado6_porcentaje = (lado6*100)/totales;
        textView_lado6_porcentaje.setText(lado6_porcentaje + str_lado6_porcentaje);
        progressBar_lado6.setProgress(lado6_porcentaje);
